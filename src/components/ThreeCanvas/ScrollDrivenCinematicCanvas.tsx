...
// --------------------------------------------------------------------------
// Passive Global Scroll State to prevent DOM Layout Thrashing in useFrame
// --------------------------------------------------------------------------
const scrollState = {
  progress: 0,
  targetProgress: 0,
...
const ArchitecturalLuxuryRoom: React.FC = () => {
  ...
  return (
    <group position={[0, 0, 0]}>
      ...
      {[-7.2, -4.8, -2.4, 0, 2.4, 4.8, 7.2].map((x, i) => (
        <group key={`moulding-${i}`} position={[x, 1.3, -4.46]}>
          ...
          <mesh position={[0, 0.7, 0]}>
            <RoundedBox args={[1.9, 2.8, 0.03]} radius={0.01} smoothness={1}>
              <primitive object={materials.wallMoulding} attach="material" />
            </RoundedBox>
          </mesh>
          <mesh position={[0, 0.7, 0.012]}>
            <RoundedBox args={[1.7, 2.6, 0.02]} radius={0.008} smoothness={1}>
              <primitive object={materials.darkTealWall} attach="material" />
            </RoundedBox>
          </mesh>
          <mesh position={[0, 0.7, 0.02]}>
            <RoundedBox args={[1.52, 2.42, 0.015]} radius={0.008} smoothness={1}>
              <primitive object={materials.wallMoulding} attach="material" />
            </RoundedBox>
          </mesh>
          ...
          <mesh position={[0, -1.3, 0]}>
            <RoundedBox args={[1.9, 0.9, 0.03]} radius={0.01} smoothness={1}>
              <primitive object={materials.wallMoulding} attach="material" />
            </RoundedBox>
          </mesh>
          <mesh position={[0, -1.3, 0.012]}>
            <RoundedBox args={[1.7, 0.72, 0.02]} radius={0.008} smoothness={1}>
              <primitive object={materials.darkTealWall} attach="material" />
            </RoundedBox>
          </mesh>
        </group>
      ...
      {/* 3. Warm Wall Sconces with Golden Radial Glows (matching image) */}
      {[-2.4, 2.4].map((sx, idx) => (
      ...
      <group position={[5.4, 0.6, -3.9]}>
        <mesh position={[0, 0, 0]}>
          <RoundedBox args={[3.2, 5.2, 0.65]} radius={0.03} smoothness={1}>
      ...
      <group position={[2.6, -0.82, -2.9]}>
        <mesh position={[0, 0.32, 0]}>
          <RoundedBox args={[1.7, 0.02, 0.85]} radius={0.005} smoothness={1}>
...
// --------------------------------------------------------------------------
// Floating Luminous Stardust & Particle Wave Ribbon (Ultra-Fast Shader-less)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// 1. Hero Stage Model: Sculpted Emerald Velvet Armchair (Exact match to image)
// --------------------------------------------------------------------------
  ...
  return (
    <group position={[0, 0, 0]}>
      ...
      <mesh position={[0, -0.42, 0]}>
        <RoundedBox args={[1.36, 0.08, 1.26]} radius={0.03} smoothness={2}>
          <primitive object={materials.teakWood} attach="material" />
        </RoundedBox>
      </mesh>
      ...
      {[-0.68, 0.68].map((sideX, idx) => (
        <group key={`chair-side-${idx}`} position={[sideX, 0, 0]}>
          <mesh position={[0, 0.18, 0.05]} rotation={[-0.08, 0, 0]}>
            <RoundedBox args={[0.09, 0.065, 1.24]} radius={0.02} smoothness={2}>
              <primitive object={materials.teakWood} attach="material" />
            </RoundedBox>
          </mesh>

          <mesh position={[0, -0.48, 0.5]} rotation={[0.12, 0, idx === 0 ? -0.1 : 0.1]}>
            <cylinderGeometry args={[0.034, 0.02, 0.72, 12]} />
            <primitive object={materials.teakWood} attach="material" />
          </mesh>

          <mesh position={[0, -0.48, -0.52]} rotation={[-0.22, 0, idx === 0 ? -0.1 : 0.1]}>
            <cylinderGeometry args={[0.036, 0.02, 0.74, 12]} />
            <primitive object={materials.teakWood} attach="material" />
          </mesh>

          <mesh position={[0, -0.16, 0]} rotation={[0.42, 0, 0]}>
            <RoundedBox args={[0.07, 0.44, 0.07]} radius={0.015} smoothness={1}>
              <primitive object={materials.teakWood} attach="material" />
            </RoundedBox>
          </mesh>

          <mesh position={[0, -0.82, 0.54]}>
            <cylinderGeometry args={[0.022, 0.019, 0.1, 10]} />
            <primitive object={materials.champagneBrass} attach="material" />
          </mesh>
      ...
      <group position={[0, -0.22, 0.06]}>
        <mesh position={[0, 0, 0]}>
          <RoundedBox args={[1.28, 0.28, 1.2]} radius={0.08} smoothness={2}>
            <primitive object={materials.emeraldVelvet} attach="material" />
          </RoundedBox>
        </mesh>
        <mesh position={[0, 0.12, -0.02]}>
          <RoundedBox args={[1.22, 0.14, 1.14]} radius={0.07} smoothness={2}>
            <primitive object={materials.emeraldVelvet} attach="material" />
          </RoundedBox>
        </mesh>
      </group>
      ...
      <group position={[0, 0.46, -0.46]} rotation={[-0.16, 0, 0]}>
        <mesh>
          <RoundedBox args={[1.26, 1.08, 0.26]} radius={0.1} smoothness={2}>
            <primitive object={materials.emeraldVelvet} attach="material" />
          </RoundedBox>
        </mesh>
        <mesh position={[0, 0, -0.12]}>
          <RoundedBox args={[1.32, 1.12, 0.05]} radius={0.03} smoothness={2}>
            <primitive object={materials.teakWood} attach="material" />
          </RoundedBox>
        </mesh>
      </group>

      {/* Soft Lightweight Radial Contact Shadow under the Chair */}
      <mesh position={[0, -0.88, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <planeGeometry args={[1.8, 1.8]} />
        <meshBasicMaterial color="#050C0A" transparent opacity={0.65} />
      </mesh>
    </group>
  );
};
...
const DiningTableSuiteModel: React.FC = () => {
  ...
  return (
    <group position={[0, 0, 0]}>
      <mesh position={[0, 0.32, 0]}>
        <RoundedBox args={[2.8, 0.09, 1.4]} radius={0.03} smoothness={2}>
          <primitive object={materials.teakWood} attach="material" />
        </RoundedBox>
      </mesh>
      ...
      {[-0.85, 0.85].map((x, i) => (
        <group key={i} position={[x, -0.22, 0]}>
          <mesh position={[0, 0, -0.32]} rotation={[0.08, 0, 0]}>
            <RoundedBox args={[0.12, 0.85, 0.1]} radius={0.02} smoothness={1}>
              <primitive object={materials.teakWood} attach="material" />
            </RoundedBox>
          </mesh>
          <mesh position={[0, 0, 0.32]} rotation={[-0.08, 0, 0]}>
          ...
          <mesh position={[0, -0.42, 0]}>
            <RoundedBox args={[0.16, 0.08, 1.05]} radius={0.02} smoothness={1}>
              <primitive object={materials.teakWood} attach="material" />
            </RoundedBox>
          </mesh>
        </group>
      ...
      <group position={[-1.6, -0.15, 0.1]} rotation={[0, 0.45, 0]}>
        <mesh position={[0, 0, 0]}>
          <RoundedBox args={[0.65, 0.09, 0.65]} radius={0.03} smoothness={1}>
            <primitive object={materials.ivoryBoucle} attach="material" />
          </RoundedBox>
        </mesh>
        <mesh position={[0, 0.42, -0.28]} rotation={[-0.1, 0, 0]}>
          <RoundedBox args={[0.62, 0.4, 0.06]} radius={0.025} smoothness={1}>
            <primitive object={materials.teakWood} attach="material" />
          </RoundedBox>
        </mesh>
      </group>
  ...
  return (
    <group position={[0, 0, 0]}>
      <mesh position={[0, 0.35, 0]}>
        <RoundedBox args={[2.6, 0.08, 1.3]} radius={0.025} smoothness={2}>
          <primitive object={materials.walnutWood} attach="material" />
        </RoundedBox>
      </mesh>
      ...
      <group position={[-0.85, -0.05, 0]}>
        <mesh>
          <RoundedBox args={[0.65, 0.68, 1.15]} radius={0.02} smoothness={1}>
            <primitive object={materials.walnutWood} attach="material" />
          </RoundedBox>
        </mesh>
      </group>
      ...
      <group position={[0.95, -0.18, 0]}>
        <mesh position={[0, 0, -0.5]}>
          <RoundedBox args={[0.08, 0.96, 0.08]} radius={0.015} smoothness={1}>
            <primitive object={materials.walnutWood} attach="material" />
          </RoundedBox>
        </mesh>
        <mesh position={[0, 0, 0.5]}>
      ...
      <group position={[0, 0.1, -0.7]} rotation={[0, 0.25, 0]}>
        <mesh position={[0, 0, 0]}>
          <RoundedBox args={[0.78, 0.1, 0.7]} radius={0.04} smoothness={1}>
            <primitive object={materials.emeraldVelvet} attach="material" />
          </RoundedBox>
        </mesh>
        <mesh position={[0, 0.5, -0.32]} rotation={[-0.1, 0, 0]}>
          <RoundedBox args={[0.74, 0.85, 0.12]} radius={0.04} smoothness={1}>
            <primitive object={materials.emeraldVelvet} attach="material" />
          </RoundedBox>
        </mesh>
      </group>
...
// --------------------------------------------------------------------------
// 4. Stage 3 Model: Minimalist King Bed & Floating Nightstand
// --------------------------------------------------------------------------
  ...
  return (
    <group position={[0, 0, 0]}>
      <mesh position={[0, -0.4, 0]}>
        <RoundedBox args={[2.5, 0.22, 2.7]} radius={0.03} smoothness={1}>
          <primitive object={materials.teakWood} attach="material" />
        </RoundedBox>
      </mesh>
      ...
      <group position={[0, 0.45, -1.3]}>
        <mesh>
          <RoundedBox args={[2.7, 1.45, 0.2]} radius={0.05} smoothness={1}>
            <primitive object={materials.ivoryBoucle} attach="material" />
          </RoundedBox>
        </mesh>
      </group>
      ...
      <mesh position={[0, -0.12, 0.05]}>
        <RoundedBox args={[2.2, 0.36, 2.3]} radius={0.06} smoothness={1}>
          <primitive object={materials.ivoryBoucle} attach="material" />
        </RoundedBox>
      </mesh>
      <mesh position={[0, 0.02, 0.45]}>
        <RoundedBox args={[2.22, 0.16, 1.4]} radius={0.05} smoothness={1}>
          <primitive object={materials.emeraldVelvet} attach="material" />
        </RoundedBox>
      </mesh>
    </group>
  ...
  return (
    <group position={[0, 0, 0]}>
      <mesh position={[0, -0.65, 0]}>
        <cylinderGeometry args={[1.5, 1.55, 0.18, 24]} />
        <primitive object={materials.honedMarble} attach="material" />
      </mesh>

      <mesh position={[0, -0.45, 0]}>
        <cylinderGeometry args={[1.15, 1.2, 0.24, 24]} />
        <primitive object={materials.teakWood} attach="material" />
      </mesh>

      <group ref={crestRef} position={[0, 0.65, 0]}>
        <mesh>
          <torusGeometry args={[0.48, 0.022, 8, 24]} />
          <primitive object={materials.champagneBrass} attach="material" />
        </mesh>
...
// --------------------------------------------------------------------------
// Multi-Model Stage Orchestrator (120Hz Ultra-Smooth Interpolation)
// --------------------------------------------------------------------------
...
const MultiStageOrchestrator: React.FC<StageRigProps> = ({ onSectionChange }) => {
  ...
  useFrame((state, delta) => {
    // Zero layout recalculations: read cached scroll state directly
    scrollState.progress = THREE.MathUtils.lerp(
      scrollState.progress,
      scrollState.targetProgress,
      Math.min(delta * 6.5, 1.0)
    );
    ...
    const computeStageTransform = (
      ...
      const baseRotY = (p - stageCenter) * 1.2 + (stageIndex === 0 ? -0.22 : stageIndex % 2 === 0 ? -0.35 : 0.35);
      stageRef.current.rotation.y = THREE.MathUtils.lerp(
        stageRef.current.rotation.y,
        baseRotY + pointerX * 0.15,
        lerpSpeed
      );
    ...
    computeStageTransform(0, stage0Ref);
    computeStageTransform(1, stage1Ref);
    computeStageTransform(2, stage2Ref);
    computeStageTransform(3, stage3Ref);
    computeStageTransform(4, stage4Ref);
  });
...
export const ScrollDrivenCinematicCanvas: React.FC<ScrollDrivenCinematicCanvasProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <ambientLight intensity={0.65} color="#FFF5EB" />
        ...
        <directionalLight
          ...
          color="#F59E0B"
        />
        <pointLight position={[0.85, -0.4, -0.8]} intensity={0.4} color="#E8BE78" />
